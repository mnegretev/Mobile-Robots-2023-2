...
def callback_scan(msg):
    ...
    #
    DISTANCE_THRESHOLD  = 0.01     #Distance threshold to consider a point as part of a candidate line. 
    MIN_POINTS_COUNTING = 20       #Minimum number of points a line should contain.
