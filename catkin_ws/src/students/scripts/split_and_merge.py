...
NAME = "Iván Adrián Farfán CAnales"
...
def callback_scan(msg):
    ...
    MIN_POINTS_COUNTING = 7       #Minimum number of points a line should contain.
    RHO_TOLERANCE       = 0.001    #RHO and THETA error tolerance to consider two lines as one.
