...
def callback_scan(msg):
    ...
    #
    DISTANCE_THRESHOLD  = 0.20     #Distance threshold to consider a point as part of a candidate line. 
    MIN_POINTS_COUNTING = 10       #Minimum number of points a line should contain.
    RHO_TOLERANCE       = 1.0    #RHO and THETA error tolerance to consider two lines as one.
    THETA_TOLERANCE     = 1.0
